...
import 'package:legacyhub/features/examples/controllers/splash_controller_old.dart';
...
class SplashScreenOld extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final controller = Get.put(SplashControllerOld());
  ...
  Widget _buildCircularDots(SplashControllerOld controller) {
